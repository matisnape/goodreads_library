defmodule GoodreadsLibraryWeb.BookLiveTest do
  ...
  @create_attrs %{author: "some author", authorlf: "some authorlf", average_rating: 120.5, book_id: 42, bookshelves: [], date_added: ~D[2010-04-17], date_read: ~D[2010-04-17], pages_count: 42, publisher: "some publisher", title: "some title"}
